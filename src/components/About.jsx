  ...
  return (
    ...
    <section id='about' className=' h-full w-full flex flex-col md:flex-row items-center justify-center'>
      ...
      <div className=' p-6 md:w-[45%] md:h-full xl:text-xl'>
        <h3 className='text-m tracking-widest  uppercase py-2 border-b text-red-700/100 border-red-700/100'>From Waitress to Web Developer: My Journey to Finding My Passion</h3>
